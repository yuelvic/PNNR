...
public interface ApiService {
    ...
    Observable<User> updateUser(@Header("application-id") String appId, @Header("secret-key") String restKey,
                                @Header("user-token") String userToken, @Path("app_id") String app_id,
